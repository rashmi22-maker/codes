...
This program will implement hash table where at each array index, we will create a Binary tree, to prevent key collision.
Key having same index will be stored in Binary tree as it can store multiple data.*/
#include<stdio.h>
#include<conio.h>
#include<stdlib.h>
